...
namespace LibMinecraft.Model.Packets
{
    ...
    public class NamedEntitySpawnPacket : Packet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NamedEntitySpawnPacket"/> class.
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <remarks></remarks>
        public NamedEntitySpawnPacket(int EntityID, string EntityName, Vector3 EntityLocation,
        ...
        {
            get { return PacketID.NamedEntitySpawn; }
        }
